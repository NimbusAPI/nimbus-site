...
Nimbus is a .NET messaging framework that provides an abstraction layer over various messaging transports. Write your messaging code once, and run it on Azure Service Bus, Redis, AMQP (ActiveMQ Artemis), NATS.io, RabbitMQ, LavinMQ, or even SQL Server or Postgres without changing your application code.
...
- **NATS** - Ultra-fast cloud-native messaging with optional JetStream persistence
- **SQL Server** - Database-backed messaging using your existing SQL Server instance
- **PostgreSQL** - Database-backed messaging using your existing PostgreSQL instance
