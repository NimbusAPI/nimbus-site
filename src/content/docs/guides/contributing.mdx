---
title: "Contributing"
description: "How contributions work and what to expect as a contributor or maintainer"
category: "guides"
order: 4
---
...
- **Found a bug?** → [Open an issue](#reporting-bugs)
- **Have a question?** → Start a discussion
- **Want to add a feature?** → [Propose it first](#feature-requests)
- **Need commercial support?** → [Get in touch](#commercial-support)
...
Nimbus is provided as-is under an MIT license. Community support is best-effort when maintainers have time.
