...
| Feature | Azure Service Bus | Redis | AMQP | NATS | SQL Server | PostgreSQL | In-Process |
|---------|------------------|-------|------|------|------------|------------|------------|
| **Deployment** | Cloud (Azure) | Self-hosted or Cloud | Self-hosted | Self-hosted or Cloud | Existing DB | Existing DB | N/A |
| **Extra infra required** | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ |
| **Durability** | ⭐⭐⭐⭐⭐ | ⭐⭐⭐ | ⭐⭐⭐⭐ | ⭐⭐⭐ / ⭐⭐⭐⭐ (JetStream) | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐ |
| **Performance** | ⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐⭐ | ⭐⭐⭐ | ⭐⭐⭐⭐⭐ |
| **Setup Complexity** | ⭐⭐ | ⭐⭐⭐⭐ | ⭐⭐ | ⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ |
| **Cost** | Pay per use | Free (self-host) | Free (self-host) | Free (self-host) | Existing DB cost | Existing DB cost | Free |
| **Message delivery** | Push | Push | Push | Push | Polling | Polling | In-memory |
| **Message Size** | 256KB / 1MB | 512MB | 100MB+ | 1MB (default) | VARBINARY(MAX) | BYTEA | Unlimited |
...
| Feature | Azure Service Bus | Redis | AMQP | NATS | SQL Server | PostgreSQL | In-Process |
|---------|------------------|-------|------|------|------------|------------|------------|
| **Scheduled Delivery** | ✅ Native | ⚠️ Polling | ✅ Native | ✅ Simulated | ✅ `visible_after` | ✅ `visible_after` | ✅ Full support |
| **Message TTL** | ✅ Native | ✅ Native | ✅ Native | ✅ JetStream | ✅ `expires_at` | ✅ `expires_at` | ✅ Simulated |
...
| **Duplicate Detection** | ✅ Native | ⚠️ Manual | ⚠️ Manual | ⚠️ Manual | ⚠️ Manual | ⚠️ Manual | ⚠️ Manual |
| **Encryption at rest** | ✅ Native | ⚠️ Manual | ⚠️ Manual | ⚠️ Manual | ✅ TDE | ✅ Native | ❌ |
