---
title: "Introducing Nimbus: Transport-Agnostic .NET Messaging"
description: "Learn about Nimbus, a .NET messaging framework that lets you write code once and run it on any transport."
publishDate: 2025-01-15
author: "Nimbus Team"
tags: ["announcement", "introduction", "messaging"]
---

We're excited to introduce **Nimbus**, a .NET messaging framework that provides a clean abstraction over popular messaging transports like Azure Service Bus, Redis, and ActiveMQ.
